<template>
  <div class="home">
    ...
    <div class="list">
      <List title="正在上映" :api="onlineMovieApi"></List>
      <List title="TOP250" :api="topMovieApi"></List>
    </div>
    <footer></footer>
  </div>
</template>
